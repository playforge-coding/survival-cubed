...
use crate::block::{
    ...
    DRAGON_PLATE_SPELL, DRAGON_SCALE, DRAGONIAN_STEED, FIRE_KEY, FORGE, GOLD_INGOT, IRON_ARMOR,
    IRON_AXE, IRON_INGOT, IRON_PICKAXE, IRON_SWORD, LADDER, LOG, MINOTAUR_HORN, MUSKET, PAPER,
    PICKAXE, QUEST_BOARD, RAW_GOLD, RAW_IRON, RAW_MEAT, RAW_TUNGSTEN, RESTORE_SPELL, ROPE,
    ROPE_LADDER, SIGN, STICK, STONE, STONE_AXE, STONE_BRICKS, STONE_PICKAXE, STONE_SWORD,
    SUMMONER_SPELL, SUNBURST_SPELL, TUNGSTEN_ARMOR, TUNGSTEN_AXE, TUNGSTEN_INGOT, TUNGSTEN_PICKAXE,
...
pub const RECIPES: &[Recipe] = &[
    ...
    Recipe {
        name: "Clone Dragon Plate Spell",
        inputs: &[(DRAGON_PLATE_SPELL, 1), (PAPER, 12)],
        outputs: &[(DRAGON_PLATE_SPELL, 2)],
    },
