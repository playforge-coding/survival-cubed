...
[spell](magic.md#the-dragonian-steed-spell) found in the
[demon king](entities/demon-king.md)'s loot chest. Right-click it to mount and **fly** (rise on jump,
...
| **[Gargoyle](entities/gargoyle.md)**                           | 32  | Underworld charred expanse (slightly rarer than demons) | A **stone** hopper; never walks — **springs** toward you and **jump-slams** to land on you; **only a pickaxe can hurt it** (every other weapon glances off); active at all hours            |
